...
public class XwlbHystrixExceptionDecoder implements ErrorDecoder {
  @Override
  public Exception decode(String methodKey, Response response) {
    try {
      String body = Util.toString(response.body().asReader());
      CommonException e = fromOrException(body);
      if (e.getErrorCode() != ExceptionType.COMMON_SERVER_ERROR) {
        return new HystrixBadRequestException(e.getErrorMessage(), e);
      }
      return e;
    } catch (Exception e) {
